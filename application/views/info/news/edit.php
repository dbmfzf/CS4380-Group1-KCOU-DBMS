...
<form action="" method="post"> 
    <table class="table table-bordered table-hover definewidth m10">
        <tr>
            ...
            <td><input type="text" name="dname" value="<?php echo $data['nid'];?>"></td>
        </tr>
        <tr>
            <td width = "15%" class="tableleft">Title</td>
            <td><input type="text" name="dname" value="<?php echo $data['title'];?>"></td>
        </tr>
        <tr>
            <td width = "15%" class="tableleft">Type</td>
            <td><input type="text" name="dname" value="<?php echo $data['type'];?>"></td>
        </tr>
        <tr>
        	<script type="text/javascript">
            	UE.getEditor('myEditor')
        	</script>
        	<textarea name="content" id="myEditor"><?php echo $data['Conntent'];?>这里写你的初始化内容</textarea></td>
        </tr>
    </table>
